(() => {
  'use strict';
  const D={
    'Đồng bộ với Web Server 3000 · 1 submit dispatcher · IMAGE / VIDEO queue':['Đồng bộ với Web Server 3000 · 1 bộ điều phối · hàng đợi ẢNH / VIDEO','Synced with Web Server 3000 · 1 submit dispatcher · IMAGE / VIDEO queues'],
